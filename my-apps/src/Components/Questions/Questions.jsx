...
function Questions() {
  ...
  const questions = [
    ...
    {
      text: "Diğer insanların yanındayken heyecanımı kontrol edebilirim.",
      options: [
        { id: 0, text: "asla", isCorrect: false },
        { id: 1, text: "nadiren", isCorrect: false },
        { id: 3, text: "sıklıkla", isCorrect: true },
      ...
      <div className="container">
        ...
        {showFinalResult ? (
          <div className="result">
            <h1>Sonuç</h1>
            <h2>
              {score} Toplam {questions.length} Senin -{" "}
              {(score / questions.length) * 100}% - Kendine Güvenin
            </h2>
            <button onClick={() => restartGame()}>Tekrar Et</button>
          </div>
        ) : (
          <div className="question-card">
            <h2>
              Soru {currentQuestion + 1} Toplam {questions.length}
            </h2>
